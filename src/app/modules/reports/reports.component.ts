...
const REPORTS_ENDPOINTS = environment.REPORTS_ENDPOINTS;
const SERVICE_URL = environment.SERVICE_URL;
const API_ENDPOINT = environment.API_ENDPOINT;
let reportURL = REPORTS_ENDPOINTS.reportInitialURL+REPORTS_ENDPOINTS.reportIds.mileageReportUrl+"&navContentPaneEnabled=false&filterPaneEnabled=false"
@Component({
